...
module ETABS =
        ...
        let using (i: InstanceType) (v: Version) : (ETABSObject * SAPModel) =
            ...
            let etabs =
                ...
                | Helper.V17 _, ExistingLiveInstance ->
                    ETABSObject.V17(Marshal.GetActiveObject("CSI.ETABS.API.ETABSObject") :?> ETABSv17.cOAPI)
                | Helper.V19 _, ExistingLiveInstance ->
                    ETABSObject.V19(Marshal.GetActiveObject("CSI.ETABS.API.ETABSObject") :?> ETABSv1.cOAPI)
    ...
    let close (app: Result<ETABSObject * SAPModel, IOError>) (saveOption: SaveOption) : unit =
        ...
        | Ok(e, _) ->
            ...
            with :? RemotingException ->
                printfn $"RemotingException safely caught during shutdown."
        | Error e -> printfn "%A" e
