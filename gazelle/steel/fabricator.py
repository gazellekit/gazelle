...
from gazelle.steel.sections.abc import SectionDesignation, SectionProperties
from gazelle.steel.sections.collections import S, SteelSections
...
from gazelle.units import Metre
